...
$sel = mysqli_select_db($bd, $mysql_database);
if(!$sel)
{
  die("Could not select database" . mysqli_connect_error());
}
...
<?php 
		 $ret= $mysqli -> query("SELECT * FROM registration where id = '".$_GET['id']."'");
			...
			<tr>
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  <td width="32%" valign="top" class="heading">Block Name : </td>
                  
                      <td class="comb-value1"><span class="comb-value"><?php echo $row['Hostel_block'];?></span></td>
                    </tr>
                  <tr>
                <tr>
