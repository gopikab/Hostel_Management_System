...
<body>
 ...
 -->
                ...
                <div class="group">
                    ...
                    <!-- i class="fas fa-user"></i> -->
                    <!-- <input type="text" class="form-control mb" name="username" placeholder="Username" required="required" />
                </div>
            </div>
                          -->           <!--  <div class=" w3l-form-group"> -->
                    ...
                    <i class="fas fa-unlock"></i> -->
                    <input type="password" placeholder="Password" name="password" class="form-control mb">
                    <!-- <input type="password" class="form-control mb" name="pwd" placeholder="Password" required="required" /> -->
                     </div>
            </div>
